...
const MomentDeVie = () => {
  return (
    <div className="min-h-screen bg-pastelPink">
      <Header />
        ...
        <div className="container mx-auto px-3">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-8xl mx-auto">
              Habituée à capturer l'intensité de l'instant sur scène, je mets cette même sensibilité au service de votre histoire : un regard échangé, une larme discrète, un éclat de rire, une main serrée un peu plus fort. A travers des images authentiques et lumineuses, revivez à l'infini l'ambiance de votre évènement, les personnes que vous aimez. Les petits détails qui ont compté pour vous, et les émotions qui vous ont traversé.
            </p>
          </div>
